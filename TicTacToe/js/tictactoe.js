...
function placeXOrO(squareNumber) {
    ...
    // function that lets computer play its turn
...
function checkWinConditions() {
    ...
    function arrayIncludes(squareA, sqaureB, squareC) {
...
// makes the body element unclickable when it is the computers turn
function disableClick() {
    body.style.pointerEvents='none';
    setTimeout(function () {body.style.pointerEvents='auto';},1000);
}

// places the place sound we put in earlier
function audio(audioURL) {
    let audio = new Audio(audioURL);
    audio.play();
}

// function draws the win line
...
// resets game after someone wins or there is a tie
function resetGame() {
    for (let i=0; i<9;i++) {
